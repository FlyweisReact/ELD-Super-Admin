...
const EditTruckLiability = ({ handleClose, show, fetchApi, prevData }) => {
  ...
  useEffect(() => {
    if (show && prevData) {
      ...
      setLiabilityInsuranceExpireDate(prevData?.liabilityInsuranceExpireDate?.slice(0,10))
      setLiabilityInsuranceEmailAlertDaysPrior(prevData?.liabilityInsuranceEmailAlertDaysPrior)
    }
  }, [show && prevData]);
            ...
            <div className="gap-5 justify-center mt-5 flex flex-col">
              <div>
                ...
                <InputComponent
                  placeholder=""
                  className="text-input"
                  onChangeEvent={(e) => setLiabilityInsuranceName(e.target.value)}
              ...
              <div>
                ...
                <InputComponent
                  placeholder=""
                  className="text-input"
                  onChangeEvent={(e) => setLiabilityInsuranceNumber(e.target.value)}
              ...
              <div>
                ...
                <InputComponent
                  placeholder=""
                  className="text-input"
                  onChangeEvent={(e) => setLiabilityInsuranceExpireDate(e.target.value)}
              ...
              <div>
                ...
                <InputComponent
                  placeholder=""
                  className="text-input"
                  onChangeEvent={(e) => setLiabilityInsuranceEmailAlertDaysPrior(e.target.value)}
