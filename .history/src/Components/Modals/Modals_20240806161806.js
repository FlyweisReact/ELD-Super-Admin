...
const EditTruckLiability = ({ handleClose, show, fetchApi, prevData }) => {
  ...
  const [expireDate, setExpireDate] = useState("");
  const [emailAlertDaysPrior, setEmailAlertDaysPrios] = useState(0);
  "liabilityInsuranceName": "ABC Insurance",
    "liabilityInsuranceNumber": "INS123456",
    "liabilityInsuranceExpireDate": "2024-06-30",
    "liabilityInsuranceIsEmail": true,
    "liabilityInsuranceEmailAlertDaysPrior": 15
    ...
    const [ liabilityInsuranceExpireDate , setLiabilityInsuranceExpireDate ] = useState("")
    const [ liabilityInsuranceEmailAlertDaysPrior , setLiabilityInsuranceEmailAlertDaysPrior ] = useState("")
