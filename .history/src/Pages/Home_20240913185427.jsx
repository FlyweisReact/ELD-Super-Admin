  ...
  return onClickEvent ? (
    <div className="dashboard-cards" onClick={onClickEvent}>
      ...
      <div className="flex justify-center items-center mt-10 mb-6">
        <div className="rounded-full w-[100px] h-[180px] bg-white flex justify-center items-center ">
          <p className="bg-[#E8FDFF] w-[100px] h-[100px] rounded-full flex justify-center items-center text-[20px] text-[#1FADEA] font-bold">
      ...
      <div className="dashboard-cards" onClick={() => navigate(link)}>
        ...
        <div className="flex justify-center items-center mt-10 mb-6">
          <div className="roundBg flex justify-center items-center ">
            <p className="bg-white w-[80px] h-[80px] rounded-full flex justify-center items-center text-[20px] text-[#1FADEA] font-bold">
              {count}
            </p>
          </div>
        </div>
