                    ...
                    <div className="bg-[#F0FAFB73]  w-[380px] h-[320px]  box-shadow rounded-xl pl-5 pr-5 pt-8 pb-8">
                      ...
                      <div className="mt-5 flex flex-col gap-2">
                        <div className="flex gap-2">
                          ...
                          <div className="text-[#666666]"> {data?.data?.cargoInsuranceName} </div>
                        </div>
                        <div className="flex gap-2">
                          <div className="text-[#666666] font-semibold">
                            Number:
                          </div>
                          <div className="text-[#666666]"> {data?.data?.cargoInsuranceNumber} </div>
                        </div>
                        <div className="flex gap-2">
                          <div className="text-[#666666] font-semibold">
                            Expiry Date:
                          </div>
                          <div className="text-[#666666]"> {dateFormatter(data?.data?.cargoInsuranceExpireDate)} </div>
                        </div>
                        <div className="flex gap-2">
                          <div className="text-[#666666] font-semibold">
                            Receive Alert:
