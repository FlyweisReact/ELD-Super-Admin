                    ...
                    <div className="bg-[#F0FAFB73]  w-[380px] h-[320px] box-shadow rounded-xl pl-5 pr-5 pt-8 pb-8">
                      ...
                      <div className="mt-5 flex flex-col gap-2">
                        <div className="flex gap-2">
                          ...
                          <div className="text-[#666666]"> {data?.data?.vehicleNumber} </div>
                        </div>
                        <div className="flex gap-2">
                          <div className="text-[#666666] font-semibold">
                            Vehicle Type:
                          </div>
                          <div className="text-[#666666]"> {data?.data?.vehicleType} </div>
                        </div>
                        <div className="flex gap-2">
                          <div className="text-[#666666] font-semibold">
                            VIN Number:
                          </div>
                          <div className="text-[#666666]"> {data?.data?.vinNumber} </div>
                        </div>
                        <div className="flex gap-2">
                          <div className="text-[#666666] font-semibold">
                            Vehicle Model:
                        ...
                        <div className="flex gap-2">
                          ...
                          <div className="text-[#666666]"> {data?.data?.fuelType} </div>
                        </div>
                        <div className="flex gap-2">
                          <div className="text-[#666666] font-semibold">
                            Fuel Tank Capacity:
                    ...
                    <div className="bg-[#F0FAFB73]  w-[380px] h-[320px]  box-shadow rounded-xl pl-5 pr-5 pt-8 pb-8">
                      ...
                      <div className="mt-5 flex flex-col gap-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          <div className="text-[#666666]"> {dateFormatter(data?.data?.expireDate)} </div>
                        </div>
                        <div className="flex gap-2">
                          <div className="text-[#666666] font-semibold">
                            Receive Alert:
                    ...
                    <div className="bg-[#F0FAFB73]  w-[380px] h-[320px]  box-shadow rounded-xl pl-5 pr-5 pt-8 pb-8">
                      ...
                      <div className="mt-5 flex flex-col gap-2">
                        <div className="flex gap-2">
                          ...
                          <div className="text-[#666666]"> {data?.data?.liabilityInsuranceName} </div>
                        </div>
                        <div className="flex gap-2">
                          <div className="text-[#666666] font-semibold">
                            Number:
                          </div>
                          <div className="text-[#666666]"> {data?.data?.liabilityInsuranceNumber} </div>
                        </div>
                        <div className="flex gap-2">
                          <div className="text-[#666666] font-semibold">
                            Expiry Date:
                          </div>
                          <div className="text-[#666666]"> {dateFormatter(data?.data?.liabilityInsuranceExpireDate)} </div>
                        </div>
                        <div className="flex gap-2">
                          <div className="text-[#666666] font-semibold">
                            Receive Alert:
