...
iimport TableLayout from "../../Components/TableLayout/TableLayout";
  ...
  const vehicleBody = [
    [
      ...
      <div className="flex gap-2 items-center justify-center">
        3<span className="danger-badges">-28.6%</span>
      </div>,
      <div className="flex gap-2 items-center justify-center">
        5<span className="success-badge">+50.0%</span>
      </div>,
      0,
    ],
  ];
