...
import { EditVehicleDetails, EditVehicleRegestration } from "../Components/Modals/Modals";
  ...
  return (
    <>
      <EditVehicleDetails
        ...
        prevData={data?.data}
      />
      <EditVehicleRegestration show={Vehicleregistration}  />
                    ...
                    <div className="bg-[#F0FAFB73]  w-[380px] h-[320px] box-shadow rounded-xl pl-5 pr-5 pt-8 pb-8">
                      ...
                      <div className="mt-5 flex flex-col gap-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          <div className="text-[#666666]"> {data?.data?.fuelTank} </div>
                        </div>
                      </div>
                    </div>
                    <div className="bg-[#F0FAFB73]  w-[380px] h-[320px]  box-shadow rounded-xl pl-5 pr-5 pt-8 pb-8">
