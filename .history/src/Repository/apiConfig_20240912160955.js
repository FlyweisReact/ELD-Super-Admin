...
const endPoints = {
  ...
  drivers: {
    getAllDrivers: ({ page = 1, limit = 10 }) =>
      `api/v1/corporate/allDriver?page=${page}&limit=${limit}&company=${companyId}`,
    updateDriverStatus: "api/v1/corporate/Truck/updateDriverStatus",
    allInactiveDriver: ({ page = 1, limit = 10 }) =>
      `api/v1/corporate/allInActiveDriver?page=${page}&limit=${limit}&company=${companyId}`,
    allDeletedDriver: ({ page = 1, limit = 10 }) =>
      `api/v1/corporate/allDeleteDriver?page=${page}&limit=${limit}&company=${companyId}`,
