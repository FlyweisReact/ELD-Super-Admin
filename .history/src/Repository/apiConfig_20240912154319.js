...
const endPoints = {
  ...
  vehicles: {
    ...
    getActiveDtc: ({ truck = "", page = 1, limit = 10 }) =>
      `api/v1/admin/Truck/allTruckActiveDtcCode?truck=${truck}&page=${page}&limit=${limit}&company={company}`,
    getActiveVehicle: ({ page = 1, limit = 10, companyId = "" }) =>
      `api/v1/admin/Truck/allTruck?page=${page}&limit=${limit}&company=${companyId}`,
    deactiveVehicles: ({ page = 1, limit = 10, companyId = "" }) =>
